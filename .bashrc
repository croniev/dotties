...
# see /USSR/share/doc/bash/examples/startup-files (in the package bash-doc)
# for examples
...
__conda_setup="$('/home/croniev/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/croniev/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/croniev/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/croniev/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
